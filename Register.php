    ...
    <form action="register-form.php" method="POST" class="register-form">
        ...
        <div class="flex">
           ...
           <div class="inputBox">
              ...
              <input type='text' placeholder="Enter your Pricing Plan" name='plan'>
           </div>
           <div class="inputBox">
              <span>Trainer :</span>
              <input type='text' placeholder="Enter Name of Trainer" name='trainer'>
           </div>
           <div class="inputBox">
...
<section class="footer">
    ...
    <div class="box">
        ...
        <div class="box">
            <h3>opening hours</h3>
            <p> <i class="fas fa-phone"></i> 0114790453 </p>
            <p> <i class="fas fa-phone"></i> 0114866154</p>
            <p> <i class="fas fa-envelope"></i> SAMSIMBA@gmail.com </p>
...
<div class="credit"> created by <span>Mutune and Simba</span> | all rights reserved! </div>
